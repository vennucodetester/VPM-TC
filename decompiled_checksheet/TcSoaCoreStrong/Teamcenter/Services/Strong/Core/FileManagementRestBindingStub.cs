...
public class FileManagementRestBindingStub : FileManagementService
{
	...
	public FileManagementRestBindingStub(Teamcenter.Soa.Client.Connection connection)
	{
	...
	public static Teamcenter.Schemas.Core._2006_03.Filemanagement.CommitDatasetFileInfo toWire(Teamcenter.Services.Strong.Core._2006_03.FileManagement.CommitDatasetFileInfo local)
	{
	...
	public static Teamcenter.Services.Strong.Core._2006_03.FileManagement.CommitDatasetFileInfo toLocal(Teamcenter.Schemas.Core._2006_03.Filemanagement.CommitDatasetFileInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2006_03.FileManagement.CommitDatasetFileInfo commitDatasetFileInfo = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.CommitDatasetFileInfo();
		...
		commitDatasetFileInfo.DatasetFileTicketInfos = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileTicketInfo[datasetFileTicketInfos.Count];
	...
	public static Teamcenter.Schemas.Core._2006_03.Filemanagement.DatasetFileInfo toWire(Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileInfo local)
	{
	...
	public static Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileInfo toLocal(Teamcenter.Schemas.Core._2006_03.Filemanagement.DatasetFileInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileInfo datasetFileInfo = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileInfo();
	...
	public static Teamcenter.Schemas.Core._2006_03.Filemanagement.DatasetFileTicketInfo toWire(Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileTicketInfo local)
	{
	...
	public static Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileTicketInfo toLocal(Teamcenter.Schemas.Core._2006_03.Filemanagement.DatasetFileTicketInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileTicketInfo datasetFileTicketInfo = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileTicketInfo();
	...
	public static Teamcenter.Services.Strong.Core._2006_03.FileManagement.FileTicketsResponse toLocal(Teamcenter.Schemas.Core._2006_03.Filemanagement.FileTicketsResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2006_03.FileManagement.FileTicketsResponse fileTicketsResponse = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.FileTicketsResponse();
	...
	public static Teamcenter.Schemas.Core._2006_03.Filemanagement.GetDatasetWriteTicketsInputData toWire(Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsInputData local)
	{
	...
	public static Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsInputData toLocal(Teamcenter.Schemas.Core._2006_03.Filemanagement.GetDatasetWriteTicketsInputData wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsInputData getDatasetWriteTicketsInputData = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsInputData();
		getDatasetWriteTicketsInputData.Dataset = (Dataset)modelManager.LoadObjectData(wire.getDataset());
		getDatasetWriteTicketsInputData.CreateNewVersion = wire.CreateNewVersion;
		IList datasetFileInfos = wire.getDatasetFileInfos();
		getDatasetWriteTicketsInputData.DatasetFileInfos = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.DatasetFileInfo[datasetFileInfos.Count];
	...
	public static Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsResponse toLocal(Teamcenter.Schemas.Core._2006_03.Filemanagement.GetDatasetWriteTicketsResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsResponse getDatasetWriteTicketsResponse = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsResponse();
		...
		getDatasetWriteTicketsResponse.CommitInfo = new Teamcenter.Services.Strong.Core._2006_03.FileManagement.CommitDatasetFileInfo[commitInfo.Count];
	...
	public static Hashtable toLocalTicketMap(ArrayList wire, PopulateModel modelManager)
	{
		...
		for (int i = 0; i < wire.Count; i++)
		{
			...
			ImanFile key = (ImanFile)modelManager.LoadObjectData(ticketMap.getKey());
	...
	public override Teamcenter.Soa.Client.Model.ServiceData CommitDatasetFiles(Teamcenter.Services.Strong.Core._2006_03.FileManagement.CommitDatasetFileInfo[] CommitInput)
	{
		try
		{
	...
	public override Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsResponse GetDatasetWriteTickets(Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsInputData[] Inputs)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Strong.Core._2006_03.FileManagement.GetDatasetWriteTicketsResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Teamcenter.Soa.Client.Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Strong.Core._2006_03.FileManagement.FileTicketsResponse GetFileReadTickets(ImanFile[] Files)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Strong.Core._2006_03.FileManagement.FileTicketsResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Teamcenter.Soa.Client.Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public static Teamcenter.Services.Strong.Core._2007_01.FileManagement.GetTransientFileTicketsResponse toLocal(Teamcenter.Schemas.Core._2007_01.Filemanagement.GetTransientFileTicketsResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2007_01.FileManagement.GetTransientFileTicketsResponse getTransientFileTicketsResponse = new Teamcenter.Services.Strong.Core._2007_01.FileManagement.GetTransientFileTicketsResponse();
		...
		getTransientFileTicketsResponse.TransientFileTicketInfos = new Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileTicketInfo[transientFileTicketInfos.Count];
	...
	public static Teamcenter.Schemas.Core._2007_01.Filemanagement.TransientFileInfo toWire(Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileInfo local)
	{
	...
	public static Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileInfo toLocal(Teamcenter.Schemas.Core._2007_01.Filemanagement.TransientFileInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileInfo transientFileInfo = new Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileInfo();
	...
	public static Teamcenter.Schemas.Core._2007_01.Filemanagement.TransientFileTicketInfo toWire(Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileTicketInfo local)
	{
	...
	public static Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileTicketInfo toLocal(Teamcenter.Schemas.Core._2007_01.Filemanagement.TransientFileTicketInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileTicketInfo transientFileTicketInfo = new Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileTicketInfo();
	...
	public override Teamcenter.Services.Strong.Core._2007_01.FileManagement.GetTransientFileTicketsResponse GetTransientFileTicketsForUpload(Teamcenter.Services.Strong.Core._2007_01.FileManagement.TransientFileInfo[] TransientFileInfos)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Strong.Core._2007_01.FileManagement.GetTransientFileTicketsResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Teamcenter.Soa.Client.Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
