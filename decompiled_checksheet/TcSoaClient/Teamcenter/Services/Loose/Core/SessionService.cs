...
using Teamcenter.Services.Loose.Core._2007_06.Session;
...
using Teamcenter.Services.Loose.Core._2009_04.Session;
...
public abstract class SessionService : Teamcenter.Services.Loose.Core._2006_03.Session.Session, Teamcenter.Services.Loose.Core._2007_01.Session.Session, Teamcenter.Services.Loose.Core._2007_06.Session.Session, Teamcenter.Services.Loose.Core._2007_12.Session.Session, Teamcenter.Services.Loose.Core._2008_03.Session.Session, Teamcenter.Services.Loose.Core._2008_06.Session.Session, Teamcenter.Services.Loose.Core._2009_04.Session.Session, Teamcenter.Services.Loose.Core._2010_04.Session.Session, Teamcenter.Services.Loose.Core._2011_06.Session.Session, Teamcenter.Services.Loose.Core._2012_02.Session.Session
{
	...
	public virtual Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse Login(string Username, string Password, string Group, string Role, string SessionDiscriminator)
	{
		throw new NotImplementedException();
	}

	[Obsolete("As of Teamcenter 10, use the loginSSO operation from the _2008_06 namespace.", false)]
	public virtual Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse LoginSSO(string Username, string SsoCredentials, string Group, string Role, string SessionDiscriminator)
	{
		throw new NotImplementedException();
	}
	...
	public virtual ServiceData SetSessionGroupMember(ModelObject GroupMember)
	{
		throw new NotImplementedException();
	}
	...
	public virtual ServiceData SetAndEvaluateIdDisplayRule(ModelObject[] IdentifiableObjects, ModelObject DisplayRule, bool SetRuleAsCurrentInDB)
	{
		throw new NotImplementedException();
	}
	...
	public virtual Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse Login(string Username, string Password, string Group, string Role, string Locale, string SessionDiscriminator)
	{
		throw new NotImplementedException();
	}

	public virtual Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse LoginSSO(string Username, string SsoCredentials, string Group, string Role, string Locale, string SessionDiscriminator)
	{
		throw new NotImplementedException();
	}
	...
	public virtual Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse Login(Credentials Credentials)
	{
		throw new NotImplementedException();
	}

	public virtual Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse LoginSSO(Credentials Credentials)
	{
		throw new NotImplementedException();
	}
