...
using Teamcenter.Services.Loose.Core._2006_03.Session;
using Teamcenter.Services.Loose.Core._2007_01.Session;
using Teamcenter.Services.Loose.Core._2007_12.Session;
using Teamcenter.Services.Loose.Core._2008_03.Session;
using Teamcenter.Services.Loose.Core._2008_06.Session;
using Teamcenter.Services.Loose.Core._2010_04.Session;
...
public class SessionRestBindingStub : SessionService
{
	...
	public static Teamcenter.Schemas.Core._2006_03.Session.GetAvailableServicesResponse toWire(Teamcenter.Services.Loose.Core._2006_03.Session.GetAvailableServicesResponse local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2006_03.Session.GetAvailableServicesResponse toLocal(Teamcenter.Schemas.Core._2006_03.Session.GetAvailableServicesResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2006_03.Session.GetAvailableServicesResponse getAvailableServicesResponse = new Teamcenter.Services.Loose.Core._2006_03.Session.GetAvailableServicesResponse();
	...
	public static Teamcenter.Services.Loose.Core._2006_03.Session.GetGroupMembershipResponse toLocal(Teamcenter.Schemas.Core._2006_03.Session.GetGroupMembershipResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2006_03.Session.GetGroupMembershipResponse getGroupMembershipResponse = new Teamcenter.Services.Loose.Core._2006_03.Session.GetGroupMembershipResponse();
		...
		getGroupMembershipResponse.GroupMembers = new Teamcenter.Soa.Client.Model.ModelObject[groupMembers.Count];
		for (int i = 0; i < groupMembers.Count; i++)
		{
			getGroupMembershipResponse.GroupMembers[i] = modelManager.LoadObjectData((Teamcenter.Schemas.Soa._2006_03.Base.ModelObject)groupMembers[i]);
		}
		return getGroupMembershipResponse;
	}

	public static Teamcenter.Services.Loose.Core._2006_03.Session.GetSessionGroupMemberResponse toLocal(Teamcenter.Schemas.Core._2006_03.Session.GetSessionGroupMemberResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2006_03.Session.GetSessionGroupMemberResponse getSessionGroupMemberResponse = new Teamcenter.Services.Loose.Core._2006_03.Session.GetSessionGroupMemberResponse();
		getSessionGroupMemberResponse.ServiceData = modelManager.LoadServiceData(wire.getServiceData());
		getSessionGroupMemberResponse.GroupMember = modelManager.LoadObjectData(wire.getGroupMember());
		return getSessionGroupMemberResponse;
	}

	public static Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse toLocal(Teamcenter.Schemas.Core._2006_03.Session.LoginResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse loginResponse = new Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse();
		loginResponse.ServiceData = modelManager.LoadServiceData(wire.getServiceData());
		loginResponse.User = modelManager.LoadObjectData(wire.getUser());
		loginResponse.GroupMember = modelManager.LoadObjectData(wire.getGroupMember());
		return loginResponse;
	}

	public static Teamcenter.Services.Loose.Core._2006_03.Session.PreferencesResponse toLocal(Teamcenter.Schemas.Core._2006_03.Session.PreferencesResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2006_03.Session.PreferencesResponse preferencesResponse = new Teamcenter.Services.Loose.Core._2006_03.Session.PreferencesResponse();
	...
	public static Teamcenter.Schemas.Core._2006_03.Session.PrefSetting toWire(Teamcenter.Services.Loose.Core._2006_03.Session.PrefSetting local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2006_03.Session.PrefSetting toLocal(Teamcenter.Schemas.Core._2006_03.Session.PrefSetting wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2006_03.Session.PrefSetting prefSetting = new Teamcenter.Services.Loose.Core._2006_03.Session.PrefSetting();
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.PreferencesResponse GetPreferences(string PrefScope, string[] PrefNames)
	{
		try
		{
			...
			Teamcenter.Services.Loose.Core._2006_03.Session.PreferencesResponse result = toLocal(wire, modelManager);
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.PreferencesResponse SetPreferences(Teamcenter.Services.Loose.Core._2006_03.Session.PrefSetting[] Settings)
	{
		try
		{
			restSender.PushRequestId();
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.GetAvailableServicesResponse GetAvailableServices()
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2006_03.Session.GetAvailableServicesResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.GetGroupMembershipResponse GetGroupMembership()
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2006_03.Session.GetGroupMembershipResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.GetSessionGroupMemberResponse GetSessionGroupMember()
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2006_03.Session.GetSessionGroupMemberResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse Login(string Username, string Password, string Group, string Role, string SessionDiscriminator)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse LoginSSO(string Username, string SsoCredentials, string Group, string Role, string SessionDiscriminator)
	{
		try
		{
			restSender.PushRequestId();
	...
	public override Teamcenter.Soa.Client.Model.ServiceData SetSessionGroupMember(Teamcenter.Soa.Client.Model.ModelObject GroupMember)
	{
		try
		{
			restSender.PushRequestId();
	...
	public static Teamcenter.Services.Loose.Core._2007_01.Session.GetTCSessionInfoResponse toLocal(Teamcenter.Schemas.Core._2007_01.Session.GetTCSessionInfoResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2007_01.Session.GetTCSessionInfoResponse getTCSessionInfoResponse = new Teamcenter.Services.Loose.Core._2007_01.Session.GetTCSessionInfoResponse();
		...
		getTCSessionInfoResponse.User = modelManager.LoadObjectData(wire.getUser());
		getTCSessionInfoResponse.Group = modelManager.LoadObjectData(wire.getGroup());
		getTCSessionInfoResponse.Role = modelManager.LoadObjectData(wire.getRole());
		getTCSessionInfoResponse.TcVolume = modelManager.LoadObjectData(wire.getTcVolume());
		getTCSessionInfoResponse.Project = modelManager.LoadObjectData(wire.getProject());
		getTCSessionInfoResponse.WorkContext = modelManager.LoadObjectData(wire.getWorkContext());
		getTCSessionInfoResponse.Site = modelManager.LoadObjectData(wire.getSite());
		...
		getTCSessionInfoResponse.TextInfos = new Teamcenter.Services.Loose.Core._2007_01.Session.TextInfo[textInfos.Count];
	...
	public static Teamcenter.Services.Loose.Core._2007_01.Session.MultiPreferencesResponse toLocal(Teamcenter.Schemas.Core._2007_01.Session.MultiPreferencesResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2007_01.Session.MultiPreferencesResponse multiPreferencesResponse = new Teamcenter.Services.Loose.Core._2007_01.Session.MultiPreferencesResponse();
		...
		multiPreferencesResponse.Preferences = new Teamcenter.Services.Loose.Core._2007_01.Session.ReturnedPreferences[preferences.Count];
	...
	public static Teamcenter.Schemas.Core._2007_01.Session.ReturnedPreferences toWire(Teamcenter.Services.Loose.Core._2007_01.Session.ReturnedPreferences local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2007_01.Session.ReturnedPreferences toLocal(Teamcenter.Schemas.Core._2007_01.Session.ReturnedPreferences wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2007_01.Session.ReturnedPreferences returnedPreferences = new Teamcenter.Services.Loose.Core._2007_01.Session.ReturnedPreferences();
	...
	public static Teamcenter.Schemas.Core._2007_01.Session.ScopedPreferenceNames toWire(Teamcenter.Services.Loose.Core._2007_01.Session.ScopedPreferenceNames local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2007_01.Session.ScopedPreferenceNames toLocal(Teamcenter.Schemas.Core._2007_01.Session.ScopedPreferenceNames wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2007_01.Session.ScopedPreferenceNames scopedPreferenceNames = new Teamcenter.Services.Loose.Core._2007_01.Session.ScopedPreferenceNames();
	...
	public static Teamcenter.Schemas.Core._2007_01.Session.TextInfo toWire(Teamcenter.Services.Loose.Core._2007_01.Session.TextInfo local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2007_01.Session.TextInfo toLocal(Teamcenter.Schemas.Core._2007_01.Session.TextInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2007_01.Session.TextInfo textInfo = new Teamcenter.Services.Loose.Core._2007_01.Session.TextInfo();
	...
	public override Teamcenter.Services.Loose.Core._2007_01.Session.MultiPreferencesResponse GetPreferences(Teamcenter.Services.Loose.Core._2007_01.Session.ScopedPreferenceNames[] RequestedPrefs)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2007_01.Session.MultiPreferencesResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2007_01.Session.GetTCSessionInfoResponse GetTCSessionInfo()
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2007_01.Session.GetTCSessionInfoResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public static Teamcenter.Schemas.Core._2007_12.Session.StateNameValue toWire(Teamcenter.Services.Loose.Core._2007_12.Session.StateNameValue local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2007_12.Session.StateNameValue toLocal(Teamcenter.Schemas.Core._2007_12.Session.StateNameValue wire, PopulateModel modelManager)
	{
	...
	public override Teamcenter.Soa.Client.Model.ServiceData SetAndEvaluateIdDisplayRule(Teamcenter.Soa.Client.Model.ModelObject[] IdentifiableObjects, Teamcenter.Soa.Client.Model.ModelObject DisplayRule, bool SetRuleAsCurrentInDB)
	{
		try
		{
			restSender.PushRequestId();
	...
	public override Teamcenter.Soa.Client.Model.ServiceData SetUserSessionState(Teamcenter.Services.Loose.Core._2007_12.Session.StateNameValue[] Pairs)
	{
		try
		{
			restSender.PushRequestId();
	...
	public static Teamcenter.Services.Loose.Core._2008_03.Session.ConnectResponse toLocal(Teamcenter.Schemas.Core._2008_03.Session.ConnectResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_03.Session.ConnectResponse connectResponse = new Teamcenter.Services.Loose.Core._2008_03.Session.ConnectResponse();
	...
	public static Teamcenter.Schemas.Core._2008_03.Session.FavoritesContainer toWire(Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesContainer local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesContainer toLocal(Teamcenter.Schemas.Core._2008_03.Session.FavoritesContainer wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesContainer favoritesContainer = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesContainer();
	...
	public static Teamcenter.Schemas.Core._2008_03.Session.FavoritesList toWire(Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesList local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesList toLocal(Teamcenter.Schemas.Core._2008_03.Session.FavoritesList wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesList favoritesList = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesList();
		IList containers = wire.getContainers();
		favoritesList.Containers = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesContainer[containers.Count];
		...
		favoritesList.Objects = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesObject[objects.Count];
	...
	public static Teamcenter.Schemas.Core._2008_03.Session.FavoritesInfo toWire(Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesInfo local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesInfo toLocal(Teamcenter.Schemas.Core._2008_03.Session.FavoritesInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesInfo favoritesInfo = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesInfo();
	...
	public static Teamcenter.Schemas.Core._2008_03.Session.FavoritesObject toWire(Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesObject local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesObject toLocal(Teamcenter.Schemas.Core._2008_03.Session.FavoritesObject wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesObject favoritesObject = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesObject();
	...
	public static Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesResponse toLocal(Teamcenter.Schemas.Core._2008_03.Session.FavoritesResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesResponse favoritesResponse = new Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesResponse();
	...
	public override Teamcenter.Services.Loose.Core._2008_03.Session.ConnectResponse Connect(string FeatureKey, string Action)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2008_03.Session.ConnectResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesResponse GetFavorites()
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Soa.Client.Model.ServiceData SetFavorites(Teamcenter.Services.Loose.Core._2008_03.Session.FavoritesInfo Input)
	{
		try
		{
			restSender.PushRequestId();
	...
	public static Teamcenter.Schemas.Core._2008_06.Session.GetDisplayStringsOutput toWire(Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsOutput local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsOutput toLocal(Teamcenter.Schemas.Core._2008_06.Session.GetDisplayStringsOutput wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsOutput getDisplayStringsOutput = new Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsOutput();
		getDisplayStringsOutput.Key = wire.getKey();
		getDisplayStringsOutput.Value = wire.getValue();
		return getDisplayStringsOutput;
	}

	public static Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsResponse toLocal(Teamcenter.Schemas.Core._2008_06.Session.GetDisplayStringsResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsResponse getDisplayStringsResponse = new Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsResponse();
		getDisplayStringsResponse.ServiceData = modelManager.LoadServiceData(wire.getServiceData());
		IList output = wire.getOutput();
		getDisplayStringsResponse.Output = new Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsOutput[output.Count];
	...
	public override Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsResponse GetDisplayStrings(string[] Info)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2008_06.Session.GetDisplayStringsResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse Login(string Username, string Password, string Group, string Role, string Locale, string SessionDiscriminator)
	{
		try
		{
			restSender.PushRequestId();
	...
	public override Teamcenter.Services.Loose.Core._2006_03.Session.LoginResponse LoginSSO(string Username, string SsoCredentials, string Group, string Role, string Locale, string SessionDiscriminator)
	{
		try
		{
			restSender.PushRequestId();
	...
	public static Teamcenter.Services.Loose.Core._2010_04.Session.GetShortcutsResponse toLocal(Teamcenter.Schemas.Core._2010_04.Session.GetShortcutsResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2010_04.Session.GetShortcutsResponse getShortcutsResponse = new Teamcenter.Services.Loose.Core._2010_04.Session.GetShortcutsResponse();
	...
	public static Teamcenter.Schemas.Core._2010_04.Session.LHNNonTcObjectSectionComponent toWire(Teamcenter.Services.Loose.Core._2010_04.Session.LHNNonTcObjectSectionComponent local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2010_04.Session.LHNNonTcObjectSectionComponent toLocal(Teamcenter.Schemas.Core._2010_04.Session.LHNNonTcObjectSectionComponent wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2010_04.Session.LHNNonTcObjectSectionComponent lHNNonTcObjectSectionComponent = new Teamcenter.Services.Loose.Core._2010_04.Session.LHNNonTcObjectSectionComponent();
		lHNNonTcObjectSectionComponent.NonTcObjects = toLocalLHNSectionComponentDetails(wire.getNonTcObjects(), modelManager);
		return lHNNonTcObjectSectionComponent;
	}

	public static Teamcenter.Schemas.Core._2010_04.Session.LHNSectionComponents toWire(Teamcenter.Services.Loose.Core._2010_04.Session.LHNSectionComponents local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2010_04.Session.LHNSectionComponents toLocal(Teamcenter.Schemas.Core._2010_04.Session.LHNSectionComponents wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2010_04.Session.LHNSectionComponents lHNSectionComponents = new Teamcenter.Services.Loose.Core._2010_04.Session.LHNSectionComponents();
	...
	public static Teamcenter.Schemas.Core._2010_04.Session.LHNTcObjectSectionComponent toWire(Teamcenter.Services.Loose.Core._2010_04.Session.LHNTcObjectSectionComponent local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2010_04.Session.LHNTcObjectSectionComponent toLocal(Teamcenter.Schemas.Core._2010_04.Session.LHNTcObjectSectionComponent wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2010_04.Session.LHNTcObjectSectionComponent lHNTcObjectSectionComponent = new Teamcenter.Services.Loose.Core._2010_04.Session.LHNTcObjectSectionComponent();
	...
	public static Teamcenter.Services.Loose.Core._2010_04.Session.MultiPreferenceResponse2 toLocal(Teamcenter.Schemas.Core._2010_04.Session.MultiPreferenceResponse2 wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2010_04.Session.MultiPreferenceResponse2 multiPreferenceResponse = new Teamcenter.Services.Loose.Core._2010_04.Session.MultiPreferenceResponse2();
		multiPreferenceResponse.Data = modelManager.LoadServiceData(wire.getServiceData());
		IList preferences = wire.getPreferences();
		multiPreferenceResponse.Preferences = new Teamcenter.Services.Loose.Core._2010_04.Session.ReturnedPreferences2[preferences.Count];
		for (int i = 0; i < preferences.Count; i++)
		{
	...
	public static Teamcenter.Schemas.Core._2010_04.Session.ReturnedPreferences2 toWire(Teamcenter.Services.Loose.Core._2010_04.Session.ReturnedPreferences2 local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2010_04.Session.ReturnedPreferences2 toLocal(Teamcenter.Schemas.Core._2010_04.Session.ReturnedPreferences2 wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2010_04.Session.ReturnedPreferences2 returnedPreferences = new Teamcenter.Services.Loose.Core._2010_04.Session.ReturnedPreferences2();
		returnedPreferences.Scope = wire.getScope();
	...
	public static ArrayList toWireLHNNonTcObjectSectionComponentMap(IDictionary LHNNonTcObjectSectionComponentMap)
	{
		...
		foreach (DictionaryEntry item in LHNNonTcObjectSectionComponentMap)
		{
			...
			lHNNonTcObjectSectionComponentMap.setValue(toWire((Teamcenter.Services.Loose.Core._2010_04.Session.LHNNonTcObjectSectionComponent)value));
	...
	public static Hashtable toLocalLHNNonTcObjectSectionComponentMap(ArrayList wire, PopulateModel modelManager)
	{
		...
		for (int i = 0; i < wire.Count; i++)
		{
			...
			Teamcenter.Services.Loose.Core._2010_04.Session.LHNNonTcObjectSectionComponent value = toLocal(lHNNonTcObjectSectionComponentMap.getValue(), modelManager);
			hashtable.Add(key, value);
		}
		return hashtable;
	}
	...
	public static ArrayList toWireLHNSectionComponentsMap(IDictionary LHNSectionComponentsMap)
	{
		...
		foreach (DictionaryEntry item in LHNSectionComponentsMap)
		{
			...
			lHNSectionComponentsMap.setValue(toWire((Teamcenter.Services.Loose.Core._2010_04.Session.LHNSectionComponents)value));
	...
	public static Hashtable toLocalLHNSectionComponentsMap(ArrayList wire, PopulateModel modelManager)
	{
		...
		for (int i = 0; i < wire.Count; i++)
		{
			...
			Teamcenter.Services.Loose.Core._2010_04.Session.LHNSectionComponents value = toLocal(lHNSectionComponentsMap.getValue(), modelManager);
			hashtable.Add(key, value);
		}
		return hashtable;
	}
	...
	public static ArrayList toWireLHNTcObjectSectionComponentMap(IDictionary LHNTcObjectSectionComponentMap)
	{
		...
		foreach (DictionaryEntry item in LHNTcObjectSectionComponentMap)
		{
			...
			lHNTcObjectSectionComponentMap.setValue(toWire((Teamcenter.Services.Loose.Core._2010_04.Session.LHNTcObjectSectionComponent)value));
	...
	public static Hashtable toLocalLHNTcObjectSectionComponentMap(ArrayList wire, PopulateModel modelManager)
	{
		...
		for (int i = 0; i < wire.Count; i++)
		{
			...
			Teamcenter.Services.Loose.Core._2010_04.Session.LHNTcObjectSectionComponent value = toLocal(lHNTcObjectSectionComponentMap.getValue(), modelManager);
			hashtable.Add(key, value);
		}
		return hashtable;
	}
	...
	[Obsolete("As of Teamcenter 10, use the getPreferences operation from the PreferenceManagement service in the Administration library.", false)]
	public override Teamcenter.Services.Loose.Core._2010_04.Session.MultiPreferenceResponse2 GetPreferences2(Teamcenter.Services.Loose.Core._2007_01.Session.ScopedPreferenceNames[] PreferenceNames)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2010_04.Session.MultiPreferenceResponse2 result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2010_04.Session.GetShortcutsResponse GetShortcuts(Hashtable ShortcutInputs)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2010_04.Session.GetShortcutsResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public static Teamcenter.Schemas.Core._2011_06.Session.ClientCacheInfo toWire(Teamcenter.Services.Loose.Core._2011_06.Session.ClientCacheInfo local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2011_06.Session.ClientCacheInfo toLocal(Teamcenter.Schemas.Core._2011_06.Session.ClientCacheInfo wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2011_06.Session.ClientCacheInfo clientCacheInfo = new Teamcenter.Services.Loose.Core._2011_06.Session.ClientCacheInfo();
		IList features = wire.getFeatures();
		clientCacheInfo.Features = new Teamcenter.Services.Loose.Core._2011_06.Session.Feature[features.Count];
	...
	public static Teamcenter.Schemas.Core._2011_06.Session.Credentials toWire(Teamcenter.Services.Loose.Core._2011_06.Session.Credentials local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2011_06.Session.Credentials toLocal(Teamcenter.Schemas.Core._2011_06.Session.Credentials wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2011_06.Session.Credentials credentials = new Teamcenter.Services.Loose.Core._2011_06.Session.Credentials();
	...
	public static Teamcenter.Schemas.Core._2011_06.Session.Feature toWire(Teamcenter.Services.Loose.Core._2011_06.Session.Feature local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2011_06.Session.Feature toLocal(Teamcenter.Schemas.Core._2011_06.Session.Feature wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2011_06.Session.Feature feature = new Teamcenter.Services.Loose.Core._2011_06.Session.Feature();
		feature.Name = wire.getName();
		feature.CacheTickets = toLocalCacheTickets(wire.getCacheTickets(), modelManager);
		return feature;
	}

	public static Teamcenter.Schemas.Core._2011_06.Session.LoginResponse toWire(Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse toLocal(Teamcenter.Schemas.Core._2011_06.Session.LoginResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse loginResponse = new Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse();
	...
	public override Teamcenter.Services.Loose.Core._2011_06.Session.ClientCacheInfo GetClientCacheData(string[] Features)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2011_06.Session.ClientCacheInfo result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse Login(Teamcenter.Services.Loose.Core._2011_06.Session.Credentials Credentials)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2011_06.Session.LoginResponse LoginSSO(Teamcenter.Services.Loose.Core._2011_06.Session.Credentials Credentials)
	{
		try
		{
			restSender.PushRequestId();
	...
	public static Teamcenter.Schemas.Core._2012_02.Session.RegisterIndex toWire(Teamcenter.Services.Loose.Core._2012_02.Session.RegisterIndex local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2012_02.Session.RegisterIndex toLocal(Teamcenter.Schemas.Core._2012_02.Session.RegisterIndex wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2012_02.Session.RegisterIndex registerIndex = new Teamcenter.Services.Loose.Core._2012_02.Session.RegisterIndex();
		registerIndex.RegistryIndex = wire.getRegistryIndex();
		return registerIndex;
	}

	public static Teamcenter.Schemas.Core._2012_02.Session.SetPolicyResponse toWire(Teamcenter.Services.Loose.Core._2012_02.Session.SetPolicyResponse local)
	{
	...
	public static Teamcenter.Services.Loose.Core._2012_02.Session.SetPolicyResponse toLocal(Teamcenter.Schemas.Core._2012_02.Session.SetPolicyResponse wire, PopulateModel modelManager)
	{
		Teamcenter.Services.Loose.Core._2012_02.Session.SetPolicyResponse setPolicyResponse = new Teamcenter.Services.Loose.Core._2012_02.Session.SetPolicyResponse();
	...
	public override Teamcenter.Services.Loose.Core._2012_02.Session.RegisterIndex RegisterState(string Level)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2012_02.Session.RegisterIndex result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
	...
	public override Teamcenter.Services.Loose.Core._2012_02.Session.SetPolicyResponse SetObjectPropertyPolicy(string PolicyName, bool UseRefCounting)
	{
		try
		{
			restSender.PushRequestId();
			...
			Teamcenter.Services.Loose.Core._2012_02.Session.SetPolicyResponse result = toLocal(wire, modelManager);
			if (!localConnection.GetOption(Connection.OPT_CACHE_MODEL_OBJECTS).Equals("true"))
			{
				localConnection.ModelManager.RemoveAllObjectsFromStore();
			}
